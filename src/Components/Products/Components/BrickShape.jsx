...
import vcbImage from "../../../Images/Brick.jpg"
                ...
                <div className="containerProduct">
                    ...
                    <div className="detailsProduct">
                        <div className="contentProduct">
                            ...
                            As a paver block manufacturer, we specialize in producing paver blocks in a variety of sizes, thicknesses, colors, and shapes to meet the needs of our customers. We provide paver blocks for a variety of functions, including industrial estates, gardens, warehouses, parking lots, and crosswalks.
                            </p>
